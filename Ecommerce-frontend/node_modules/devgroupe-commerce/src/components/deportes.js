...
function displayGames(games) {
    ...
    games.forEach(game => {
        ...
        gameElement.innerHTML = `
            ...
            <p><strong>Fecha de publicación:</strong> ${new Date(game.publicationDate).toLocaleDateString()}</p>
            ${game.imageUrls ? game.imageUrls.map(url => `<img src="${url}" alt="${game.name}">`).join('') : ""}
        `;
